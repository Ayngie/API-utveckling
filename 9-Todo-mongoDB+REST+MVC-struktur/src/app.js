...
// vi beh en skriva in ngt för detta ska fånga på alla routesen

// app.use((req, res, => {
//   return res.sendFile(path.join(__dirname, "./views/notFound.html")) //skickar in en filepath till filen vi vill skicka
//   })
// )
